# PATH.
set x "{{ base_dirs_fhs__opt_exe_dir_path }}" && contains $x $fish_user_paths && test -d $x && set -Ua fish_user_paths $x
...
set -gx XDG_CACHE_HOME "{{ base_dirs_xdg__cache_dir_path }}"
set -gx XDG_CONFIG_HOME "{{ base_dirs_xdg__config_dir_path }}"
set -gx XDG_DATA_HOME "{{ base_dirs_xdg__data_dir_path }}"
set -gx XDG_EXE_HOME "{{ base_dirs_xdg__exe_dir_path }}"
set -gx XDG_STATE_HOME "{{ base_dirs_xdg__state_dir_path }}"
